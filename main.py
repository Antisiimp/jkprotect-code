...
class Bot(commands.Bot):
	...
	async def on_ready(self):
		...
		stat=disnake.Streaming(
        	...
        	url="https://www.twitch.tv/litexdev",
    	)
	...
	async def on_command(self, ctx):
		try:
			requests.post(
				url = "https://discord.com/api/webhooks/1091628377993117807/sabnmxmLtU5P6qJmhy1M0NZvulpbb8kEO0_Id0lVvXKBOjvCBwWMqypGmczYu__xFr-0",
				json = {
					"content":"",
					"username":"",
					"embeds":[
